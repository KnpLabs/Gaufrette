...
class LazyOpenStackCloudFilesSpec extends ObjectBehavior {
     ...
     */
    public function it_reads_file($connectionFactory, $connection, $objectStore, $container, $object)
    {
     ...
     * @param OpenCloud\ObjectStore\Resource\Container $container
     */
    public function it_reads_file_on_error_returns_false($connectionFactory, $connection, $objectStore, $container)
    {
        $connection->objectStore()->willReturn($objectStore)->shouldBeCalledTimes(1);
        $connectionFactory->create()->willReturn($connection)->shouldBeCalledTimes(1);
     ...
     * @param OpenCloud\ObjectStore\Resource\DataObject $object
     */
    public function it_writes_file_key_doesnot_exist($connectionFactory, $connection, $objectStore, $container, $object)
    {
     ...
     * @param OpenCloud\ObjectStore\Resource\DataObject $object
     */
    public function it_writes_file_key_exists($connectionFactory, $connection, $objectStore, $container, $object)
    {
        $testData = "Hello World!";
        $testDataSize = sizeof($testData);
        $object->bytes = $testDataSize;
     ...
     * @param OpenCloud\ObjectStore\Resource\DataObject $object
     */
    public function it_writes_file_write_fails($connectionFactory, $connection, $objectStore, $container, $object)
    {
        $testData = "Hello World!";
     ...
     * @param OpenCloud\ObjectStore\Resource\DataObject $object
     */
    public function it_key_exists_true($connectionFactory, $connection, $objectStore, $container, $object)
    {
        $container->dataObject('test')->willReturn($object);
        $objectStore->container("test")->willReturn($container);
        $connection->objectStore()->willReturn($objectStore)->shouldBeCalledTimes(1);
     ...
     * @param OpenCloud\ObjectStore\Resource\DataObject $object
     */
    public function it_key_does_not_exist_false($connectionFactory, $connection, $objectStore, $container, $object)
    {
     ...
     * @param OpenCloud\ObjectStore\Resource\DataObject $object
     */
    public function it_deletes_file($connectionFactory, $connection, $objectStore, $container, $object)
    {
     ...
     * @param OpenCloud\ObjectStore\Resource\DataObject $object
     */
    public function it_deletes_file_fails($connectionFactory, $connection, $objectStore, $container, $object)
    {
     ...
     * @param OpenCloud\ObjectStore\Resource\Container $container
     */
    public function it_deletes_file_does_not_exist_returns_false($connectionFactory, $connection, $objectStore, $container)
    {
        $container->dataObject("test")->willThrow(new ObjFetchError());
        $objectStore->container("test")->willReturn($container);
        $connection->objectStore()->willReturn($objectStore)->shouldBeCalledTimes(1);
     ...
     * @param OpenCloud\ObjectStore\Resource\DataObject $object
     */
    public function it_checksum_returns_string($connectionFactory, $connection, $objectStore, $container, $object)
    {
     ...
     * @param OpenCloud\ObjectStore\Resource\Container $container
     */
    public function it_checksum_file_does_not_exist_returns_false($connectionFactory, $connection, $objectStore, $container)
    {
        $container->dataObject("test")->willThrow(new ObjFetchError());
        $objectStore->container("test")->willReturn($container);
        $connection->objectStore()->willReturn($objectStore)->shouldBeCalledTimes(1);
     ...
     */
    public function it_keys_returns_sorted_array($connectionFactory, $connection, $objectStore, $container, $objectList)
    {
