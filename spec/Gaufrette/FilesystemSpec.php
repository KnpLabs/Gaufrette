...
class FilesystemSpec extends ObjectBehavior
{
    ...
    public function it_gives_access_to_adapter(Adapter $adapter)
    {
        $this->getAdapter()->shouldBe($adapter);
    }

    public function it_check_if_file_exists_using_adapter(Adapter $adapter)
    {
    ...
    public function it_renames_file(Adapter $adapter)
    {
    ...
    public function it_fails_when_renamed_source_file_does_not_exist(Adapter $adapter)
    {
    ...
    public function it_fails_when_renamed_target_file_exists(Adapter $adapter)
    {
        $adapter->exists('filename')->willReturn(true);
    ...
    public function it_fails_when_rename_is_not_successful(Adapter $adapter)
    {
        $adapter->exists('filename')->willReturn(true);
        $adapter->exists('otherFilename')->willReturn(false);
    ...
    public function it_creates_file_object_for_key(Adapter $adapter)
    {
        $adapter->exists('filename')->willReturn(true);
    ...
    public function it_does_not_get_file_object_when_file_with_key_does_not_exist(Adapter $adapter)
    {
        $adapter->exists('filename')->willReturn(false);
    ...
    public function it_gets_file_object_when_file_does_not_exist_but_can_be_created(Adapter $adapter)
    {
        $adapter->exists('filename')->willReturn(false);
    ...
    public function it_delegates_file_creation_to_adapter_when_adapter_is_file_factory(ExtendedAdapter $extendedAdapter, File $file)
    {
    ...
    public function it_writes_content_to_new_file(Adapter $adapter)
    {
    ...
    public function it_updates_content_of_file(Adapter $adapter)
    {
        $adapter->write('filename', 'some content to write')->shouldBeCalled()->willReturn(21);
    ...
    public function it_does_not_update_content_of_file_when_file_cannot_be_overwriten(Adapter $adapter)
    {
        $adapter->exists('filename')->willReturn(true);
    ...
    public function it_fails_when_write_is_not_successful(Adapter $adapter)
    {
        $adapter->exists('filename')->willReturn(false);
    ...
    public function it_read_file(Adapter $adapter)
    {
        $adapter->exists('filename')->shouldBeCalled()->willReturn(true);
    ...
    public function it_does_not_read_file_which_does_not_exist(Adapter $adapter)
    {
        $adapter->exists('filename')->willReturn(false);
    ...
    public function it_fails_when_read_is_not_successful(Adapter $adapter)
    {
        $adapter->exists('filename')->willReturn(true);
    ...
    public function it_deletes_file(Adapter $adapter)
    {
        $adapter->exists('filename')->shouldBeCalled()->willReturn(true);
    ...
    public function it_does_not_delete_file_which_does_not_exist(Adapter $adapter)
    {
        $adapter->exists('filename')->willReturn(false);
    ...
    public function it_fails_when_delete_is_not_successful(Adapter $adapter)
    {
        $adapter->exists('filename')->willReturn(true);
    ...
    public function it_should_get_all_keys(Adapter $adapter)
    {
    ...
    public function it_match_listed_keys_using_specified_pattern(Adapter $adapter)
    {
    ...
    public function it_listing_directories_using_adapter_is_directory_method(Adapter $adapter)
    {
        $keys = ['filename', 'filename1', 'filename2', 'testKey', 'KeyTest', 'testkey'];
    ...
    public function it_gets_mtime_of_file_using_adapter(Adapter $adapter)
    {
        $adapter->exists('filename')->willReturn(true);
    ...
    public function it_does_not_get_mtime_of_file_which_does_not_exist(Adapter $adapter)
    {
        $adapter->exists('filename')->willReturn(false);
    ...
    public function it_calculates_file_checksum(Adapter $adapter)
    {
        $adapter->exists('filename')->shouldBeCalled()->willReturn(true);
    ...
    public function it_does_not_calculate_checksum_of_file_which_does_not_exist(Adapter $adapter)
    {
        $adapter->exists('filename')->shouldBeCalled()->willReturn(false);
    ...
    public function it_delegates_checksum_calculation_to_adapter_when_adapter_is_checksum_calculator(ExtendedAdapter $extendedAdapter)
    {
        $this->beConstructedWith($extendedAdapter);
    ...
    public function it_delegates_mime_type_resolution_to_adapter_when_adapter_is_mime_type_provider(ExtendedAdapter $extendedAdapter)
    {
        $this->beConstructedWith($extendedAdapter);
        $extendedAdapter->exists('filename')->willReturn(true);
    ...
    public function it_cannot_resolve_mime_type_if_the_adapter_cannot_provide_it(Adapter $adapter)
    {
        $adapter->exists('filename')->willReturn(true);
        $this
