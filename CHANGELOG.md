...
* Improvement of test coverage during CI builds: functional tests for AwsS3, Ftp, GridFS and PhpseclibSftp now runs on Travis (see #457, #460, #483, #484)
* Maintained adapters now have metapackage to enforce version of 3rd party libraries, and ease installation process (see #487)
* Add FilesystemInterface and makes current Filesystem implement it (see #492)
* File:
...
Also, we thank @edhgoose and @zyphlar who made patches for deprecated adapters, before those adapters were deprecated, but 
still did not see their respective work merged in this version.
